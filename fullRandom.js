...
function randomise() {
    ...
    setRace();
    document.getElementById("subraceInfo").innerHTML = " ";
    setSubRace();
}
...
function setRace() {
    ...
    // Randomise Race
                ...
                raceLink.innerHTML = race;
                raceLink.setAttribute = ("class", "moreInfo");
                raceLink.href = `${race}.html`;

                document.getElementById("raceInfo").appendChild(raceLink);
    ...
    function aasSubRace(){
        let aasArr = ["Fallen Aasimar", "Protector Aasimar", "Scourge Aasimar", "Variant Aasimar"];
            ...
            let aasLink = document.createElement("a");
            aasLink.innerHTML = aas;
            aasLink.setAttribute = ("class", "moreInfo");
            aasLink.href = `${aas}.html`;
    
            document.getElementById("subraceInfo").appendChild(aasLink);
    };
    ...
    function dwaSubRace() {
        let dwaArr = ["Grey Dwarf", "Hill Dwarf", "Mark of Warding Dwarf", "Mountain Dwarf"];
                    ...
                    let dwaLink = document.createElement("a");
                    dwaLink.innerHTML = dwa;
                    dwaLink.setAttribute = ("class", "moreInfo");
                    dwaLink.href = `${dwa}.html`;
            
                    document.getElementById("subraceInfo").appendChild(dwaLink);
